NPC.Admin.DB = NPC.Admin.DB or {}

RegisterServerEvent('npc-admin:searchRequest')
AddEventHandler('npc-admin:searchRequest', function()
...
function NPC.Admin.DB.giveCar(car, cid)
...
function NPC.Admin.DB.UnbanSteamId(steamid)
