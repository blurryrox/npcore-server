...
rootMenuConfig =  {
    ...
    },
    {
        ...
        icon = "#cuffs",
        enableMenu = function()
            return (not isDead and not isHandcuffed and not isHandcuffedAndWalking and (exports["npc-inventory"]:hasEnoughOfItem("cuffs",1,false) or isPolice))
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            return ((exports["npc-base"]:getModule("LocalPlayer"):getVar("job") == "district attorney" or isPolice or isJudge) and not isDead)
        end
    }
