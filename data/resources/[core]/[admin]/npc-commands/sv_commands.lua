function buildCommands(job,src)
    ...
    local commandExport = exports["npc-base"]:getModule("Commands")
    exports["npc-base"]:getModule("Player"):GetUser(Lsrc)
...
RegisterServerEvent("npc-commands:buildCommands")
AddEventHandler("npc-commands:buildCommands", buildCommands)
...
AddEventHandler("npc-jobmanager:playerBecameJob", function(src, job)
