...
RegisterServerEvent("npc-restart:checkRebootTime")
AddEventHandler('npc-restart:checkRebootTime', function()
...
function restartNow() SetTimeout(1000, function() TriggerEvent('npc-restart:checkRebootTime') restartNow() end) end
restartNow()

function getTax()
    local taxes = exports["npc-votesystem"]:getTaxes()
