...
RegisterNetEvent("npc-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("npc-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("npc-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("npc-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('npc-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("npc-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("npc-dirtymoney:alterDirtyMoney","ItemDrop",amount)
