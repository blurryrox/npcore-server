...
function hasDecryptGod()
    if exports["npc-inventory"]:hasEnoughOfItem("decrypterenzo",1,false,false) then
      return true
    else
      return false
    end
...
AddEventHandler('stringGangGlobalReputations', function()
    ...
    local currenttax = exports["npc-votesystem"]:getTax()
...
function getQuantitys()
    local weed = exports["npc-inventory"]:getQuantity("weedoz")
    local cocaine = exports["npc-inventory"]:getQuantity("coke5g")
    local guns = exports["npc-inventory"]:getQuantity("riflebody")
    local launder = exports["npc-inventory"]:getQuantity("inkset")
    local stolengoods = exports["npc-inventory"]:getQuantity("valuablegoods")
...
function hasEncryption()
    if (exports["npc-inventory"]:hasEnoughOfItem("decryptersess",1,false) or exports["npc-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasDevice()
    if exports["npc-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasPhone()
    if exports["npc-inventory"]:hasEnoughOfItem("mobilephone",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
    ...
    while timer > 0 do
        ...
        if not searching then
            ...
            if IsControlJustReleased(1,Controlkey["generalUse"][1]) then
                ...
                local finished = exports["npc-taskbar"]:taskBar(25000,"Searching Thug")
...
function getQuantitysH()
    local weed = exports["npc-inventory"]:getQuantity("weed5oz")
    local cocaine = exports["npc-inventory"]:getQuantity("coke50g")
    local guns = exports["npc-inventory"]:getQuantity("riflebodybox")
    local launder = exports["npc-inventory"]:getQuantity("inkcrate")
...
function attemptDecrypt()
    ...
    local usb = exports["npc-inventory"]:hasEnoughOfItem("mk2usbdevice",1,false)
    local usb2 = exports["npc-inventory"]:hasEnoughOfItem("usbdevice",1,false)
    local base = exports["npc-inventory"]:hasEnoughOfItem("decryptersess",1,false)
    local expert = exports["npc-inventory"]:hasEnoughOfItem("decrypterfv2",1,false)
    local expert2 = exports["npc-inventory"]:hasEnoughOfItem("decrypterenzo",1,false)
