...
RegisterNetEvent('npc-admin:noclipsway')
AddEventHandler('npc-admin:noclipsway', function()
noclipActive = true
end)

RegisterNetEvent('npc-admin:nofc')
AddEventHandler('npc-admin:nofc', function()
noclipActive = false
end)