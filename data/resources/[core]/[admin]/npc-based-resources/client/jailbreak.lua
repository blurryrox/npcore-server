...
function RoleplayStats()
    ...
    if exports["npc-inventory"]:hasEnoughOfItem("shitlockpick",1,false) then
        totalroleplay = totalroleplay + 10
    end

    if exports["npc-inventory"]:hasEnoughOfItem("jailfood",1,false) then
        totalroleplay = totalroleplay + 10
    end

    if exports["npc-inventory"]:hasEnoughOfItem("methbag",1,false) then
        totalroleplay = totalroleplay + 15
    end

    if exports["npc-inventory"]:hasEnoughOfItem("assphone",1,false) then
        totalroleplay = totalroleplay + 15
    ...
    if exports["npc-inventory"]:hasEnoughOfItem("slushy",1,false) then
        totalroleplay = totalroleplay + 10
    end
...
function InmateHasAll()
    if exports["npc-inventory"]:hasEnoughOfItem("slushy",1,false)
        and
        exports["npc-inventory"]:hasEnoughOfItem("-1810795771",1,false)
        and
        exports["npc-inventory"]:hasEnoughOfItem("methbag",1,false)
        and
        exports["npc-inventory"]:hasEnoughOfItem("assphone",1,false)
        and
        exports["npc-inventory"]:hasEnoughOfItem("slushy",1,false)
    then
        return true
    else
        return false
