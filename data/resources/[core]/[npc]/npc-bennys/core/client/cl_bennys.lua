...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("npc-bennys:attemptPurchase",cheap, type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("npc-bennys:purchaseSuccessful")
AddEventHandler("npc-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
end)

RegisterNetEvent("npc-bennys:purchaseFailed")
AddEventHandler("npc-bennys:purchaseFailed", function()
