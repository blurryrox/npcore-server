...
RegisterNetEvent('npc-weapons:stashitem')
AddEventHandler('npc-weapons:stashitem', function(itemnumber,amount,meta)
        ...
        if thename1 ~= "none" then
            ...
            TriggerServerEvent("npc-weapons:stashweapon", thename1, itemnumber, amount, 1,1,meta)
...
RegisterNetEvent('npc-weapons:giveweaponfromproperty')
AddEventHandler('npc-weapons:giveweaponfromproperty', function(result)
...
-- RegisterNetEvent('npc-weapons:checkinventory')
-- AddEventHandler('npc-weapons:checkinventory', function()
...
--             TriggerServerEvent("npc-weapons:checkinventory", thename1)
...
-- RegisterNetEvent('npc-weapons:takefromstash')
-- AddEventHandler('npc-weapons:takefromstash', function(itemname, quantity, itemtype, item, askedAmount,meta)
--     thename1 = GrabApartment(2)
--     if thename1 ~= "none" then
--         TriggerServerEvent("npc-weapons:takefromstash",itemname, quantity, itemtype, item, askedAmount,thename1,meta)
--     else
--         TriggerEvent("DoLongHudText", "Error finding property.",2)
--     end
-- end)
...
-- RegisterNetEvent('npc-weapons:stashweapon')
-- AddEventHandler('npc-weapons:stashweapon', function()
...
--             TriggerEvent("attachWeapons")
--             TriggerServerEvent("npc-weapons:stashweapon", thename1, weaponname, 1, 0,ammo)
...
AddEventHandler('AppRobberies:currentlyrobbing', function()
    if exports["npc-inventory"]:hasEnoughOfItem("lockpick",1) then
        checkRobbedStore()
        Citizen.Wait(1500)
