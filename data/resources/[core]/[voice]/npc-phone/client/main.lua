...
AddEventHandler("npc-jobmanager:playerBecameJob", function(job)
    if job == "trucker" then
        trucker = true
    end
end)
...
function hasDecrypt2()
    if exports["npc-inventory"]:hasEnoughOfItem("vpnxj",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasTrucker()
    if exports["npc-base"]:getModule("LocalPlayer"):getVar("job") == "trucker"  then
      return true
    else
      return false
    end
...
function hasDecrypt()
    if exports["npc-inventory"]:hasEnoughOfItem("decrypterenzo",1,false) or exports["npc-inventory"]:hasEnoughOfItem("decryptersess",1,false) or exports["npc-inventory"]:hasEnoughOfItem("decrypterfv2",1,false) and not exports["isPed"]:isPed("disabled") or exports["npc-inventory"]:hasEnoughOfItem(80,1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
function hasPhone()
    if
      (
      (exports["npc-inventory"]:hasEnoughOfItem("mobilephone",1,false) or 
      exports["npc-inventory"]:hasEnoughOfItem("stoleniphone",1,false) or 
      exports["npc-inventory"]:hasEnoughOfItem("stolens8",1,false) or
      exports["npc-inventory"]:hasEnoughOfItem("stolennokia",1,false) or
      exports["npc-inventory"]:hasEnoughOfItem("stolenpixel3",1,false) or
      exports["npc-inventory"]:hasEnoughOfItem("boomerphone",1,false))
...
function hasRadio()
    if exports["npc-inventory"]:hasEnoughOfItem("radio",1,false) and not exports["isPed"]:isPed("disabled") then
      return true
    else
      return false
    end
...
AddEventHandler('phone:addToCall', function(voipchannel)
  ...
  exports['npc-voice']:addPlayerToCall(tonumber(voipchannel))
end)
...
AddEventHandler('phone:removefromToko', function(playerRadioChannel)
  exports['npc-voice']:removePlayerFromCall()
end)
