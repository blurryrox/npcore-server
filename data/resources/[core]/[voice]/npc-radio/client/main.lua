...
function hasRadio()
  if exports["npc-inventory"]:hasEnoughOfItem("radio",1,false) then
    return true
  else
    return false
  end
...
RegisterNUICallback('volumeUp', function(data, cb)
  exports["npc-voice"]:IncreaseRadioVolume()
  cb('ok')
end)

RegisterNUICallback('volumeDown', function(data, cb)
  exports["npc-voice"]:DecreaseRadioVolume()
  cb('ok')
end)
...
function SetCustomNuiFocus(hasKeyboard, hasMouse)
  ...
  TriggerEvent("npc-voice:focus:set", HasNuiFocus, hasKeyboard, hasMouse)
end
